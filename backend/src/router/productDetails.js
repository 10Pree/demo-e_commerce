...
router.put('/product/attribute/value', controllerProductDetails.updateProductAttributesValue);
router.put('/product/variant/attribute', controllerProductDetails.updateProductVariants);
