...
export default function Page() {
    return (
        <div className="w-full h-[1300px] md:h-full">
            ...
            {/* <div className="w-full shrink-0">
                    <button className="px-8 py-2 bg-[#F97316] rounded-[8px] font-bold text-[#111827] hover:bg-[#1E3A8A] hover:text-white mr-96">ชำระ</button>
                </div> */}
        </div>
    )
}