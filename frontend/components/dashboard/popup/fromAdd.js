...
export default function FromAdd({ onClose, data, setdata }) {
    ...
    const handleChangePassword = (e) => {
        ...
        setIsPasswordValid(value !== "" ? true : null)
                ...
                <div className="w-full h-full flex flex-col items-center">
                    ...
                    <div className="w-full flex flex-col justify-center items-center gap-4">
                        ...
                        <div className="w-[50%] flex flex-col gap-2">
                            ...
                            <div className="flex gap-2 relative justify-center items-center">
                                <input name="passwordTwo" onChange={checkChangePassword} className="w-full h-10 p-3 border-2 rounded-xl" type="password" placeholder="รหัสผ่าน" />
                                {
